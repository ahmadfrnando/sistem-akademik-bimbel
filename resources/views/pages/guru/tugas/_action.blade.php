<div class="d-flex align-items-center">
    <a href="javascript:void(0)" onClick="showImportFunc({{ $id }}, {{ $kategori_tugas_id }})" class="btn btn-lihat btn-success btn-sm text-nowrap me-2" data-toggle="tooltip" data-placement="bottom" title="Import"><i class="bi bi-upload"></i></a></a>
